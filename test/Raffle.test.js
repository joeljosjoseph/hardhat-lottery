...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", function () {
          ...
          describe("enterRaffle", function () {
              ...
              it("doesnt allow to enter when raffle is calculating", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
          ...
          describe("performUpkeep", () => {
              ...
              it("updates the raffle state, emits and event, calls the vrf coordinator", async () => {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.request({ method: "evm_mine", params: [] })
          ...
          describe("fulfillRandomWords", () => {
              ...
              it("picks a winner, resets the lottery, and sends the money", async () => {
                  ...
                  for (
                      ...
                      let connectedRaffleAccount = await raffle.connect(accounts[i])
                  ...
                  //we will have to wait the fulfillRandomWords to be called
